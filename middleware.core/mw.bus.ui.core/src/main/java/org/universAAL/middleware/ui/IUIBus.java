...
public interface IUIBus {
	 ...
	 *            that has changed
	 */
	public void adaptationParametersChanged(IDialogManager dm, UIRequest uicall, String changedProp);
	 ...
	 */
	public void addNewProfile(String handlerID, UIHandlerProfile uiHandlerProfile);
	 ...
	 */
	public void removeMatchingProfile(String handlerID, UIHandlerProfile oldUIHandlerProfile);
