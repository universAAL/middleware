...
public abstract class FormControl extends FormElement {
	...
	protected FormControl(String typeURI, Object parent, Label label, PropertyPath ref,
		...
		else if (!(this instanceof Group) || !(parent instanceof Form) || ((Form) parent).getRootGroup() != null)
	...
	public MergedRestriction getRestrictions() {
		...
		MergedRestriction r1 = getLocalRestrictions(),
	...
	public boolean setProperty(String propURI, Object value) {
		...
		if (propURI.equals(PROP_CONTROL_LABEL)) {
			...
			if (value instanceof FormControl || (value instanceof Form && this instanceof Group))
				knownProp = true;
			else
				return false;
			...
			if (value instanceof MergedRestriction && !props.containsKey(propURI))
				knownProp = true;
			else
				return false;
		}
