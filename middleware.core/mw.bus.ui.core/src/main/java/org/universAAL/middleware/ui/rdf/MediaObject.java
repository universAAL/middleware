...
public class MediaObject extends Output {
	...
	public boolean setProperty(String propURI, Object value) {
		...
		if (PROP_CONTENT_TYPE.equals(propURI) || PROP_CONTENT_URL.equals(propURI)) {
			if (value instanceof String) {
				props.put(propURI, value);
				return true;
			}
		} else if (PROP_RESOLUTION_MAX_X.equals(propURI) || PROP_RESOLUTION_MAX_Y.equals(propURI)
				|| PROP_RESOLUTION_MIN_X.equals(propURI) || PROP_RESOLUTION_MIN_Y.equals(propURI)
				|| PROP_RESOLUTION_PREFERRED_X.equals(propURI) || PROP_RESOLUTION_PREFERRED_Y.equals(propURI)) {
