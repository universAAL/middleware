...
public class UIRequest extends ScopedResource implements Request {
	 ...
	 *            the dialog privacy.
	 */
	public UIRequest(Resource user, Form dialogForm, LevelRating dialogPriority, Locale dialogLang,
		...
		props.put(PROP_DIALOG_PRIORITY, dialogPriority == null ? LevelRating.low : dialogPriority);
	...
	public int getPropSerializationType(String propURI) {
		return PROP_DIALOG_FORM.equals(propURI) ? PROP_SERIALIZATION_FULL : PROP_SERIALIZATION_REDUCED;
	}
	...
	public AccessImpairment[] getImpairments() {
		...
		return l == null ? null : (AccessImpairment[]) l.toArray(new AccessImpairment[l.size()]);
	}
	...
	public Preference[] getPreferences() {
		...
		return l == null ? null : (Preference[]) l.toArray(new Preference[l.size()]);
	}
	...
	public void setImpairments(AccessImpairment[] impairments) {
		if (impairments != null && impairments.length > 0 && !props.containsKey(PROP_HAS_ACCESS_IMPAIRMENT)) {
	...
	public void setPreferences(Preference[] preferences) {
		if (preferences != null && preferences.length > 0 && !props.containsKey(PROP_HAS_PREFERENCE)) {
	...
	public void setPresentationLocation(AbsLocation presentationLocation) {
		if (presentationLocation != null && !props.containsKey(PROP_PRESENTATION_LOCATION)) {
	...
	public void setAltPresentationModality(Modality outputModality) {
		if (outputModality != null && !props.containsKey(PROP_PRESENTATION_MODALITY_ALT)) {
	...
	public boolean matches(Matchable subset) {
		...
		if (o1 != null) {
			...
			if (o2 != null && !(((LevelRating) o1).greaterEqual((LevelRating) o2)))
				return false;
		}
		...
		if (o1 != null) {
			...
			if (o2 != null && !(((ComparableIndividual) o1).greaterEqual((ComparableIndividual) o2)))
				return false;
		}
