...
public class SimplifiedApiService extends Service {
	 ...
	 * @return
	 */
	public synchronized static SimplifiedApiService createService(String namespace, String methodUri,
			String ontologyUri) {
	 ...
	 *             MY_URI or it is not accessible.
	 */
	public void addOutputWrapper(String baseURI, Class<?> clazz, Cardinality card, String[] propertyPaths)
			throws SimplifiedRegistrationException {
		int minCard, maxCard;
		switch (card) {
		case ONE_TO_ONE:
	 ...
	 * @throws SimplifiedRegistrationException
	 */
	public void addChangeEffectWrapper(String[] propPaths, String val, Class<?> type)
			throws SimplifiedRegistrationException {
		Object value = null;
		// try{
		...
		// e.printStackTrace();
		// throw new
		// SimplifiedRegistrationException("Exception during
		// addChangeEffectWrapper casting :"
