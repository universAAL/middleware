...
public class TurtleUtil {
	...
	static boolean isLanguageChar(int c) {
		return StringUtils.isAsciiLetter((char) c) || StringUtils.isDigit((char) c) || c == '-';
	}
	...
	static boolean isNameChar(int c) {
		return isNameStartChar(c) || StringUtils.isDigit((char) c) || c == '-' || c == 0x00B7
	...
	static boolean isPrefixStartChar(int c) {
		return StringUtils.isAsciiLetter((char) c) || c >= 0x00C0 && c <= 0x00D6 || c >= 0x00D8 && c <= 0x00F6
