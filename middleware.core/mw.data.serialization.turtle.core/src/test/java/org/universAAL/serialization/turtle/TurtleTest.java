...
public class TurtleTest extends TestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		// s = new TurtleParser();
		OntologyManagement.getInstance().register(null,
				new SimpleOntology(MyOntClass.MY_URI, ManagedIndividual.MY_URI, new ResourceFactory() {
	...
	public void testLanguagedLabel() {
		...
		r1.addMultiLangProp(Resource.PROP_RDFS_LABEL, new LangString("myLabel_en", "en"));
		// log(r1.toStringRecursive());
		// System.out.println(r1.toStringRecursive());
		// assertTrue(check(r1));
		r1.addMultiLangProp(Resource.PROP_RDFS_LABEL, new LangString("myLabel", LangString.LANG_LATIN));
		assertTrue(check(r1));
		r1.addMultiLangProp(Resource.PROP_RDFS_LABEL, new LangString("myLabel_de", "de"));
		assertTrue(check(r1));
	}
