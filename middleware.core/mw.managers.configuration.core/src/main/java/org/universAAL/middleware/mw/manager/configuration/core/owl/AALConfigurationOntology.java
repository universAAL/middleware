...
/**
 * This class provides the main representation of the aalconfigurationontologu ontology 
...
public final class AALConfigurationOntology extends Ontology {
  ...
  public void create() {
    ...
    oci_ConfigurationFile.addRestriction(MergedRestriction
      .getAllValuesRestrictionWithCardinality(ConfigurationFile.PROP_LOCAL_URL, 
          TypeMapper.getDatatypeURI(String.class), 1, 1));
    oci_ConfigurationFile.addDatatypeProperty(ConfigurationFile.PROP_DEFAULT_URL).setFunctional();
    oci_ConfigurationFile.addRestriction(MergedRestriction
      .getAllValuesRestrictionWithCardinality(ConfigurationFile.PROP_DEFAULT_URL, 
          TypeMapper.getDatatypeURI(String.class), 1, 1));
    oci_ConfigurationFile.addDatatypeProperty(ConfigurationFile.PROP_EXTENSION_FILTER).setFunctional();
    oci_ConfigurationFile.addRestriction(MergedRestriction
      .getAllValuesRestrictionWithCardinality(ConfigurationFile.PROP_EXTENSION_FILTER, 
          TypeMapper.getDatatypeURI(String.class), 1, 1));
    oci_ConfigurationFile.addDatatypeProperty(ConfigurationFile.PROP_CONTENT).setFunctional();
    oci_ConfigurationFile.addRestriction(MergedRestriction
	      .getAllValuesRestrictionWithCardinality(ConfigurationFile.PROP_CONTENT, 
    ...
    oci_ConfigurationParameter.addRestriction(MergedRestriction.getCardinalityRestriction(ConfigurationParameter.PROP_DEFAULT_VALUE, 1, 1));
    oci_ConfigurationParameter.addObjectProperty(ConfigurationParameter.PROP_VALUE).setFunctional();
    oci_ConfigurationParameter.addRestriction(MergedRestriction.getCardinalityRestriction(ConfigurationParameter.PROP_VALUE, 1, 1)); 
