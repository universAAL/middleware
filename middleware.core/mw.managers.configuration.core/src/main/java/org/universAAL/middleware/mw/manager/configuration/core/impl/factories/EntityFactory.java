...
package org.universAAL.middleware.mw.manager.configuration.core.impl.factories;
...
public class EntityFactory {
	...
	if (dentity instanceof ConfigurationParameter){
	    org.universAAL.middleware.mw.manager.configuration.core.owl.ConfigurationParameter cp = 
		    new org.universAAL.middleware.mw.manager.configuration.core.owl.ConfigurationParameter(uri);
	...
	if (dentity instanceof ConfigurationFile){
	    org.universAAL.middleware.mw.manager.configuration.core.owl.ConfigurationFile cf = 
		    new org.universAAL.middleware.mw.manager.configuration.core.owl.ConfigurationFile(uri);
	...
	if (dentity instanceof ConfigurationParameter){
	    ...
	    org.universAAL.middleware.mw.manager.configuration.core.owl.ConfigurationParameter cp = 
		    (org.universAAL.middleware.mw.manager.configuration.core.owl.ConfigurationParameter) entity;
	    ConfigurationParameter de = (ConfigurationParameter)dentity;
	...
	if (dentity instanceof ConfigurationFile){
	    org.universAAL.middleware.mw.manager.configuration.core.owl.ConfigurationFile cf = 
		    (org.universAAL.middleware.mw.manager.configuration.core.owl.ConfigurationFile) entity;
	    ConfigurationFile de = (ConfigurationFile)dentity;
