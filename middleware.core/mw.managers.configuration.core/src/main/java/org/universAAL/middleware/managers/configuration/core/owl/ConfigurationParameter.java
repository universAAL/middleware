...
public class ConfigurationParameter extends Entity {
	...
	public static final String PROP_DEFAULT_VALUE = ConfigurationOntology.NAMESPACE + "defaultValue";
	...
	public boolean isWellFormed() {
		return super.isWellFormed() && hasProperty(PROP_DEFAULT_VALUE) && hasProperty(PROP_VALUE);
	}
		...
		if (o instanceof List) {
			for (Object t : (List) o) {
				if (t instanceof MergedRestriction
						&& ((MergedRestriction) t).getOnProperty().equals(ConfigurationParameter.PROP_VALUE)) {
					return (MergedRestriction) t;
				}
			}
		} else if (o instanceof MergedRestriction
				&& ((MergedRestriction) o).getOnProperty().equals(ConfigurationParameter.PROP_VALUE)) {
