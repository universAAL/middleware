...
/**
 * Ontological representation of Entity in the configuration
...
public class Entity extends ManagedIndividual {
	public static final String MY_URI = ConfigurableModule.uAAL_CONFIG_FRAMEWORK_NAMESPACE + "Entity";
	public static final String PROP_VERSION = ConfigurableModule.uAAL_CONFIG_FRAMEWORK_NAMESPACE + "version";
