...
public class Entity extends ManagedIndividual {
	public static final String MY_URI = ConfigurationOntology.NAMESPACE + "Entity";
	public static final String PROP_VERSION = ConfigurationOntology.NAMESPACE + "version";
