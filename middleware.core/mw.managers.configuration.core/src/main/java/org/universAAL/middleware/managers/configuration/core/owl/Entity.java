...
public class Entity extends ManagedIndividual {
	public static final String MY_URI = AALConfigurationOntology.NAMESPACE + "Entity";
	public static final String PROP_VERSION = AALConfigurationOntology.NAMESPACE + "version";
