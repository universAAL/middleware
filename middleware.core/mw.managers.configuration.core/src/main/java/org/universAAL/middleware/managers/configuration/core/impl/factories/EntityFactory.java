...
public class EntityFactory {
	...
	public static Entity updateEntity(Entity OldEntity, DescribedEntity dentity, Locale loc) {
		...
		if (newDescription != null && !newDescription.isEmpty() && !newDescription.equals(entity.getDescription(loc))) {
		...
		if (dentity instanceof ConfigurationParameter) {
			...
			org.universAAL.middleware.managers.configuration.core.owl.ConfigurationParameter cp = (org.universAAL.middleware.managers.configuration.core.owl.ConfigurationParameter) entity;
			ConfigurationParameter de = (ConfigurationParameter) dentity;
			...
			if (!newType.equals(cp.getParameterRestriction())) {
				// update restriction to type; if different, also increase
				// version
		...
		if (dentity instanceof ConfigurationFile) {
			org.universAAL.middleware.managers.configuration.core.owl.ConfigurationFile cf = (org.universAAL.middleware.managers.configuration.core.owl.ConfigurationFile) entity;
			ConfigurationFile de = (ConfigurationFile) dentity;
