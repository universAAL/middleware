...
/**
 * Manage the Requests, waiting for responses.
 * Specifically for remote configuration editors, that need to be created when the response arrives, and then added to the {@link ConfigurableEntityManager}.
 * @author amedrano
 *
 */
public class PendingRequestsManager {
    ...
    /**
     * remove a {@link ConfigurableEntityManager}, no longer interested in responses.
     * @param manager
     */
    ...
    /**
     * Called when a response is received. for all the {@link ConfigurableEntityManager} match the possible new entities, and add them.
     * @param ents
     */
