 ...
 * configuration ontology. Methods included in this class are the
 * mandatory ones for representing an ontological concept in Java classes for
 * the universAAL platform. In addition getters and setters for properties are
 * included.
 *
 * @author
...
public class ConfigurationFile extends Entity {
	public static final String MY_URI = ConfigurableModule.uAAL_CONFIG_FRAMEWORK_NAMESPACE + "ConfigurationFile";
	public static final String PROP_LOCAL_URL = ConfigurableModule.uAAL_CONFIG_FRAMEWORK_NAMESPACE + "localURL";
	public static final String PROP_DEFAULT_URL = ConfigurableModule.uAAL_CONFIG_FRAMEWORK_NAMESPACE + "defaultURL";
	public static final String PROP_CONTENT = ConfigurableModule.uAAL_CONFIG_FRAMEWORK_NAMESPACE + "content";
	public static final String PROP_EXTENSION_FILTER = ConfigurableModule.uAAL_CONFIG_FRAMEWORK_NAMESPACE + "extensionFilter";
	...
	public boolean isWellFormed() {
		return super.isWellFormed() && hasProperty(PROP_LOCAL_URL) && hasProperty(PROP_DEFAULT_URL)
