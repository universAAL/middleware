 ...
 * configurationontologu ontology. Methods included in this class are the
...
public class ConfigurationFile extends Entity {
	public static final String MY_URI = ConfigurationOntology.NAMESPACE + "ConfigurationFile";
	public static final String PROP_LOCAL_URL = ConfigurationOntology.NAMESPACE + "localURL";
	public static final String PROP_DEFAULT_URL = ConfigurationOntology.NAMESPACE + "defaultURL";
	public static final String PROP_CONTENT = ConfigurationOntology.NAMESPACE + "content";
	public static final String PROP_EXTENSION_FILTER = ConfigurationOntology.NAMESPACE + "extensionFilter";
