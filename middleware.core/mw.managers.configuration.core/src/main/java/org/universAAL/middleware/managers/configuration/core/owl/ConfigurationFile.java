...
public class ConfigurationFile extends Entity {
	public static final String MY_URI = AALConfigurationOntology.NAMESPACE + "ConfigurationFile";
	public static final String PROP_LOCAL_URL = AALConfigurationOntology.NAMESPACE + "localURL";
	public static final String PROP_DEFAULT_URL = AALConfigurationOntology.NAMESPACE + "defaultURL";
	public static final String PROP_CONTENT = AALConfigurationOntology.NAMESPACE + "content";
	public static final String PROP_EXTENSION_FILTER = AALConfigurationOntology.NAMESPACE + "extensionFilter";
