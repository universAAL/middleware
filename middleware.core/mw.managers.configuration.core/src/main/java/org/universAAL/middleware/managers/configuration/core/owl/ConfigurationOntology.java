...
/**
 * This class provides the main representation of the configurationontologu
 * ontology for the universAAL platform.
 *
 * @author Generated by the OntologyUML2Java transformation of Studio
 */
public final class ConfigurationOntology extends Ontology {
	...
	public static final String NAMESPACE = "http://ontology.universAAL.org/ConfigurationOntology#";

	public ConfigurationOntology() {
		super(NAMESPACE);
	}
	...
	public void create() {
		...
		r.setResourceLabel("ConfigurationOntology");
		addImport(DataRepOntology.NAMESPACE);

		// ******* Declaration of regular classes of the ontology ******* //
		OntClassInfoSetup oci_Entity = createNewOntClassInfo(Entity.MY_URI, factory, 1);
		OntClassInfoSetup oci_ConfigurationFile = createNewOntClassInfo(ConfigurationFile.MY_URI, factory, 2);
		OntClassInfoSetup oci_ConfigurationParameter = createNewOntClassInfo(ConfigurationParameter.MY_URI, factory, 3);
		...
		oci_Entity.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(Entity.PROP_VERSION,
				TypeMapper.getDatatypeURI(Long.class), 1, 1));

		oci_ConfigurationFile.setResourceComment("An entity that is represented by a file");
		oci_ConfigurationFile.setResourceLabel("ConfigurationFile");
		oci_ConfigurationFile.addSuperClass(Entity.MY_URI);
		oci_ConfigurationFile.addDatatypeProperty(ConfigurationFile.PROP_LOCAL_URL).setFunctional();
		oci_ConfigurationFile.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				ConfigurationFile.PROP_LOCAL_URL, TypeMapper.getDatatypeURI(String.class), 1, 1));
		oci_ConfigurationFile.addDatatypeProperty(ConfigurationFile.PROP_DEFAULT_URL).setFunctional();
		oci_ConfigurationFile.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				ConfigurationFile.PROP_DEFAULT_URL, TypeMapper.getDatatypeURI(String.class), 1, 1));
		oci_ConfigurationFile.addDatatypeProperty(ConfigurationFile.PROP_EXTENSION_FILTER).setFunctional();
		oci_ConfigurationFile.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				ConfigurationFile.PROP_EXTENSION_FILTER, TypeMapper.getDatatypeURI(String.class), 1, 1));
		oci_ConfigurationFile.addDatatypeProperty(ConfigurationFile.PROP_CONTENT).setFunctional();
		oci_ConfigurationFile.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
