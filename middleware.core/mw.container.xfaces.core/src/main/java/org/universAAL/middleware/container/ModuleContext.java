...
public interface ModuleContext {
     ...
     * @return The {@link File} pointing to the correct configuration folder of this module, 
     * The folder will be created for the module to use directly.
     * @since 3.1.1
     */
    public File getConfigHome();
    
    /**
     * Get the Data folder for this module, the general storage space where data generated by the module
     * should be stored. 
     * This folder may be cleared by system Admin.
     * @return a File pointing to the corresponding reserved folder for data for this module, 
     * The folder will be created for the module to use directly.
     * @since 3.1.1
     */
