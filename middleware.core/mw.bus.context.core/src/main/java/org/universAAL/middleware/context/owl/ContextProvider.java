...
public class ContextProvider extends ManagedIndividual {
	...
	public int getPropSerializationType(String propURI) {
		if (PROP_CONTEXT_SOURCE.equals(propURI) || PROP_CONTEXT_PROVIDER_TYPE.equals(propURI))
	...
	public ContextEventPattern[] getProvidedEvents() {
		...
		return (l == null) ? null : (ContextEventPattern[]) l.toArray(new ContextEventPattern[l.size()]);
	}
	...
	public boolean setContextSources(ManagedIndividual[] sources) {
		if (sources != null && sources.length > 0 && !props.containsKey(PROP_CONTEXT_SOURCE)) {
	...
	public boolean setProperty(String propURI, Object value) {
		if (PROP_CONTEXT_SOURCE.equals(propURI)) {
			...
			return false;
		} else if (PROP_CONTEXT_PROVIDER_TYPE.equals(propURI) && value instanceof ContextProviderType)
	...
	public boolean setProvidedEvents(ContextEventPattern[] myEvents) {
		if (myEvents != null && myEvents.length > 0 && !props.containsKey(PROP_CONTEXT_PROVIDED_EVENTS)) {
