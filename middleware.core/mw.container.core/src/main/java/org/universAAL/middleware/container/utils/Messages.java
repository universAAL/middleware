...
public class Messages {
	 ...
	 *             if propertiesFile has incorrect extension
	 */
	 ...
	 *             if propertiesFile has incorrect extension
	 */
	public Messages(File propertiesFile, Locale initialLocale) throws IOException, IllegalArgumentException {
	 ...
	 * @throws IllegalArgumentException
	 *             if propertiesURL has incorrect extension
	 */
	public Messages(URL propertiesURL) throws IOException, IllegalArgumentException {
	 ...
	 *             if propertiesURL has incorrect extension
	 */
	public Messages(URL propertiesURL, Locale initialLocale) throws IOException, IllegalArgumentException {
	...
	private URL internationalizedFile(Locale loc) {
		try {
			return new URL(defaultResource.getProtocol(), defaultResource.getHost(),
					defaultResource.getFile().replace(FILE_EXTENSION, "_" + loc.getLanguage() + FILE_EXTENSION));
	 ...
	 * @throws IOException
	 *             if file not found, or could not read.
	 */
