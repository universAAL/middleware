...
public class Messages {
     ...
     */
    public Messages(URL propertiesURL) throws IOException,
	    IllegalArgumentException {
	...
	if (propertiesURL == null)
	    ...
	    throw new IllegalArgumentException("File should be a \""
		    + FILE_EXTENSION + "\" file");
	...
	try {
	    return new URL(defaultResource.getProtocol(),
		    defaultResource.getHost(), defaultResource.getFile()
