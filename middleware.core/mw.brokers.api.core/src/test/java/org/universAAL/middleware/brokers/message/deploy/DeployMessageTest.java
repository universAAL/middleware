...
public class DeployMessageTest {
	...
	@Test
	public void ByteArrayBase64EncodeSerializeDeserializeDecodeTest() throws Exception {

		byte[] dati = new byte[] { (byte) 0x03, (byte) 0x08, (byte) 0x60, (byte) 0x99 };
	...
	public void GSONControlMessageTest() throws Exception {
		...
		DeployMessage destinazione = gson.fromJson(serializedMessage, DeployMessage.class);
	...
	public void BrokerMessageTest() throws Exception {
		...
		String destinazione = GsonParserBuilder.getInstance().fromJson(serializedMessage, BrokerMessage.class)
				.toString();
