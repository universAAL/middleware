...
/**
 * A configuration entity that refers to a file. Receive a {@link File} object
 * in
 ...
 * as the value for the Scope define in this DescribedEntity. <br>
 * It is recommended to use this Entity with caution, specially if the expected
 * files are big. As they will be transmitted in a non-optimal way. Don't use
 * this entity for property files, use the {@link ConfigurationParameter}
 * Entities for each expected line in the file.
 * 
 * @author amedrano
 * 
 */
