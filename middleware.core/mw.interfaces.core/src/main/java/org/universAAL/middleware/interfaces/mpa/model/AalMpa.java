...
@XmlType(name = "", propOrder = { "app", "applicationProfile", "applicationProvider", "applicationManagement",
		"applicationPart" })
...
public class AalMpa implements Serializable {
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "name", "distributed", "appId", "description", "license", "sla" })
	...
	public static class ApplicationProfile implements Serializable {
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "targetProfile", "alternativeProfiles", "requirredOntologies" })
		public static class AalSpace implements Serializable {
			 ...
			 * 
			 */
			public void setAlternativeProfiles(AalMpa.ApplicationProfile.AalSpace.AlternativeProfiles value) {
			 ...
			 * 
			 */
			public void setRequirredOntologies(AalMpa.ApplicationProfile.AalSpace.RequirredOntologies value) {
			...
			public static class RequirredOntologies implements Serializable {
				...
				public boolean isSetOntology() {
					return ((this.ontology != null) && (!this.ontology.isEmpty()));
				}
