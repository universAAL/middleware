...
public class OntologyType implements Serializable {
     ...
     * 
     * @return possible object is {@link OntologyType.Location }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link OntologyType.Location }
     * 
     */
	...
	private final static long serialVersionUID = 12343L;
	@XmlElementRefs({
		@XmlElementRef(name = "url", namespace = "http://universaal.org/aal-mpa/v1.0.0", type = JAXBElement.class),
		@XmlElementRef(name = "path", namespace = "http://universaal.org/aal-mpa/v1.0.0", type = JAXBElement.class),
		@XmlElementRef(name = "runtimeId", namespace = "http://universaal.org/aal-mpa/v1.0.0", type = JAXBElement.class) })
	 ...
	 * <CODE>set</CODE> method for the pathOrRuntimeIdOrUrl property.
	 * 
	 * <p>
	...
	public boolean isSetPathOrRuntimeIdOrUrl() {
	    return ((this.pathOrRuntimeIdOrUrl != null) && (!this.pathOrRuntimeIdOrUrl
		    .isEmpty()));
	}
