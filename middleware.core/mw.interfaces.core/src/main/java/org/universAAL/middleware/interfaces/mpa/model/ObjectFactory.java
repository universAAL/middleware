...
public class ObjectFactory {
	...
	private final static QName _OntologyTypeLocationUrl_QNAME = new QName("http://universaal.org/aal-mpa/v1.0.0",
			"url");
	private final static QName _OntologyTypeLocationRuntimeId_QNAME = new QName("http://universaal.org/aal-mpa/v1.0.0",
			"runtimeId");
	private final static QName _OntologyTypeLocationPath_QNAME = new QName("http://universaal.org/aal-mpa/v1.0.0",
			"path");
	...
	public JAXBElement<Object> createOntologyTypeLocationUrl(Object value) {
		return new JAXBElement<Object>(_OntologyTypeLocationUrl_QNAME, Object.class, OntologyType.Location.class,
				value);
	}
	...
	public JAXBElement<String> createOntologyTypeLocationRuntimeId(String value) {
		return new JAXBElement<String>(_OntologyTypeLocationRuntimeId_QNAME, String.class, OntologyType.Location.class,
				value);
	}
	...
	public JAXBElement<String> createOntologyTypeLocationPath(String value) {
		return new JAXBElement<String>(_OntologyTypeLocationPath_QNAME, String.class, OntologyType.Location.class,
				value);
	}
