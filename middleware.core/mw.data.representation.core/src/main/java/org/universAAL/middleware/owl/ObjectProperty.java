...
public final class ObjectProperty extends Property {
	...
	public static final String MY_URI = TypeExpression.OWL_NAMESPACE + "ObjectProperty";

	/** @see ObjectPropertySetup#setInverseFunctional() */
	public static final String TYPE_INVERSE_FUNCTIONAL = ManagedIndividual.OWL_NAMESPACE + "InverseFunctionalProperty";

	/** @see ObjectPropertySetup#setReflexive() */
	public static final String TYPE_REFLEXIVE = ManagedIndividual.OWL_NAMESPACE + "ReflexiveProperty";

	/** @see ObjectPropertySetup#setIrreflexive() */
	public static final String TYPE_IRREFLEXIVE = ManagedIndividual.OWL_NAMESPACE + "IrreflexiveProperty";

	/** @see ObjectPropertySetup#setSymmetric() */
	public static final String TYPE_SYMMETRIC = ManagedIndividual.OWL_NAMESPACE + "SymmetricProperty";

	/** @see ObjectPropertySetup#setAsymmetric() */
	public static final String TYPE_ASYMMETRIC = ManagedIndividual.OWL_NAMESPACE + "AsymmetricProperty";

	/** @see ObjectPropertySetup#setTransitive() */
	public static final String TYPE_TRANSITIVE = ManagedIndividual.OWL_NAMESPACE + "TransitiveProperty";
