...
public abstract class ManagedIndividual extends FinalizedResource {
	...
	public static final boolean checkCompatibility(String supertypeURI, String subtypeURI) {
		...
		if (supertypeURI.equals(subtypeURI) || TypeMapper.isCompatible(supertypeURI, subtypeURI))
			return true;
	 ...
	 *            URI of the property.
	 */
	public static final MergedRestriction getClassRestrictionsOnProperty(String classURI, String propURI) {
	...
	public static final String getTypeURI(Object o) {
		...
		return (o instanceof ManagedIndividual) ? ((ManagedIndividual) o).getClassURI() : TypeMapper.getDatatypeURI(o);
	}
	...
	public static final boolean isRegisteredClassURI(String classURI) {
		LogUtils.logDebug(SharedResources.moduleContext, ManagedIndividual.class, "isRegisteredClassURI",
				new Object[] {
						"This method is deprecated, please use OntologyManagement.isRegisteredClass(classURI, true)." },
				null);
	...
	public boolean isWellFormed() {
		...
		for (int i = 0; i < propURIs.length; i++) {
			MergedRestriction r = getClassRestrictionsOnProperty(classURI, propURIs[i]);
	...
	public boolean setProperty(String propURI, Object value) {
		...
		MergedRestriction r = OntologyManagement.getInstance().getOntClassInfo(getClassURI())
				.getRestrictionsOnProp(propURI);
		...
		if (r == null) {
			...
			if (value instanceof Resource && !(value instanceof ManagedIndividual))
	...
	public boolean setPropertyPathFromOffset(String[] propPath, int fromIndex, Object value, boolean force) {
		try {
			...
			if (tmp == null) {
				if (value == null)
					return true;
				MergedRestriction r = getClassRestrictionsOnProperty(getClassURI(), propPath[fromIndex]);
				if (r != null)
