...
public final class MaxCardinalityRestriction extends PropertyRestriction {
	...
	public static final String PROP_OWL_MAX_QUALIFIED_CARDINALITY = OWL_NAMESPACE + "maxQualifiedCardinality";
	 ...
	 * @param value
	 *            The maximum cardinality that this property must have.
	 */
	public MaxCardinalityRestriction(String propURI, int value) {
		if (propURI == null)
			throw new NullPointerException();
		if (value < 0)
			throw new IllegalArgumentException("Value of a Max Cardinality Restriction must be non-negative: " + value);
	 ...
	 */
	public int getValue() {
		NonNegativeInteger i = (NonNegativeInteger) props.get(PROP_OWL_MAX_CARDINALITY);
		if (i == null)
			return -1;
		return i.intValue();
	}
	...
	public boolean isWellFormed() {
		return getOnProperty() != null && (hasProperty(PROP_OWL_MAX_CARDINALITY));
	}
	...
	public boolean setProperty(String propURI, Object o) {
		...
		if (PROP_OWL_MAX_CARDINALITY.equals(propURI)) {
			...
			LogUtils.logError(SharedResources.moduleContext, MaxCardinalityRestriction.class, "setProperty",
					new Object[] { "Trying to set the max cardinality with an invalid value: ", o, " of type ",
