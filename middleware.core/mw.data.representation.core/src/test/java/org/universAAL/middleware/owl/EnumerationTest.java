...
public class EnumerationTest extends TestCase {
	...
	public void testMethods() {
		...
		assertTrue(e0.getNamedSuperclasses()[0].equals(TypeMapper.getDatatypeURI(i0)));
		assertTrue(e0.getNamedSuperclasses()[0].equals(TypeMapper.getDatatypeURI(Integer.class)));
		...
		assertTrue(e01.getNamedSuperclasses()[0].equals(TypeMapper.getDatatypeURI(i0)));
		assertTrue(e01.getNamedSuperclasses()[0].equals(TypeMapper.getDatatypeURI(Integer.class)));
		...
		// -- this may change --
		Enumeration e_1 = new Enumeration(new Object[] { Integer.valueOf(0), MyClass1.MY_URI });
