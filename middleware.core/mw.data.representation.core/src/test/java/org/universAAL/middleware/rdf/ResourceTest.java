...
public class ResourceTest extends TestCase {
	...
	public void testGetOrConstructLabel() {
		...
		assertTrue("My LightSource \"Light Source\"".equals(r.getOrConstructLabel("My LightSource")));
	...
	public void testDeepCopy() {
		...
		r1.setProperty("testprop",
				new MergedRestriction("onProperty").addRestriction(new MinCardinalityRestriction("onProperty", 32))
						.addRestriction(new MaxCardinalityRestriction("onProperty", 42)
	...
	public void testLangString() {
		...
		assertTrue(en.equals(r.getMultiLangProp(p, LangString.LANG_ENGLISH, false).getString()));
		assertTrue(de.equals(r.getMultiLangProp(p, LangString.LANG_GERMAN, false).getString()));

		r.addMultiLangProp(p, new LangString("somevalue", LangString.LANG_GERMAN));
