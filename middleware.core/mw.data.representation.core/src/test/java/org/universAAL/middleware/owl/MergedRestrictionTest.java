...
public class MergedRestrictionTest extends TestCase {
	...
	public void testAppend1() {
		...
		for (int i = 0; i < 2; i++) {
			...
			if (i == 0) {
				 ...
				 *	--PROP_C1C2--> Val
				 */
				m1 = MergedRestriction.getAllValuesRestriction(MyClass2.PROP_C2C3, MyClass3.MY_URI);
				root = m1.appendTo(root, new String[] { MyClass1.PROP_C1C2, MyClass2.PROP_C2C3 });
				assertFalse(root == null);
				m1 = MergedRestriction.getFixedValueRestriction(MyClass1.PROP_C1C2, myClass2);
			...
			test1.setProperty(MyClass1.PROP_C1C2, new MyClass2(myClass2.getURI()));
			assertTrue(root.hasMember(test1));
		...
		assertFalse(m2 == null);
		m1 = MergedRestriction.getAllValuesRestriction(MyClass2.PROP_C2C3, MyClass3Sub1.MY_URI);
		m2 = m1.appendTo(m2, new String[] { MyClass1.PROP_C1C2, MyClass2.PROP_C2C3 });
		assertFalse(m2 == null);
		...
		m2 = m1.appendTo(m2, new String[] { MyClass1.PROP_C1C2 });
		assertFalse(m2 == null);
		m1 = MergedRestriction.getAllValuesRestriction(MyClass2.PROP_C2C3, MyClass2.MY_URI);
		m2 = m1.appendTo(m2, new String[] { MyClass1.PROP_C1C2, MyClass2.PROP_C2C3 });
		assertFalse(m2 == null);
	...
	public void testAppend2() {
		 ...
		 */
		m1 = MergedRestriction.getAllValuesRestriction(MyClass1.PROP_C1C2, MyClass2.MY_URI);
		root = m1.appendTo(root, new String[] { MyClass1.PROP_C1C2 });
		assertFalse(root == null);

		m1 = MergedRestriction.getFixedValueRestriction(MyClass2.PROP_C2C3, myClass3);
		root = m1.appendTo(root, new String[] { MyClass1.PROP_C1C2, MyClass2.PROP_C2C3 });
		assertFalse(root == null);
		...
		// test HasValue
		for (int j = 0; j < 2; j++)
			if (((UnmodifiableResource) (l.get(j))).instanceOf(HasValueRestriction.class))
				ur = (UnmodifiableResource) l.get(j);
		assertFalse(ur == null);
		assertTrue(((Resource) (ur.getProperty(HasValueRestriction.PROP_OWL_HAS_VALUE))).getURI() == myClass3.getURI());
	}
}
