...
public class BusMessage implements BrokerMessage {
	...
	public static String trySerializationAsContent(Object o) {
		return (contentSerializer == null) ? o.toString() : contentSerializer.serialize(o);
	}

	public static Object deserializeAsContent(String s) {
		return (contentSerializer == null) ? null : contentSerializer.deserialize(s);
	}
	...
	public BusMessage(MessageType type, Object content, AbstractBus creator) {
		if (type == null || content == null || type == MessageType.p2p_reply || type == MessageType.reply
				|| creator == null) {
	...
	public BusMessage(String message, AbstractBus creator) {
		...
		int i = message.indexOf("</uAAL:BusMessage#id>\n  <uAAL:BusMessage#type>");
		if (i < 0) {
			throw new IllegalArgumentException();
		}
		...
		i += 46;
		int j = message.indexOf("</uAAL:BusMessage#type>\n  <uAAL:BusMessage#content>\n", i);
		if (j < 0) {
			throw new IllegalArgumentException();
		}
	 ...
	 */
	public static BusMessage createP2PReply(String messageIDInReplyTo, PeerCard receiver, Object content,
			AbstractBus creator) {
		if (content == null || messageIDInReplyTo == null || receiver == null || creator == null) {
			return null;
		}
	...
	public boolean receiverResidesOnDifferentPeer() {
		...
		for (PeerCard pc : receiver) {
			if (!pc.getPeerID().equals(thisPeer.getPeerID())) {
				return true;
			}
		}
		return false;
	...
	public boolean senderResidesOnDifferentPeer() {
		return sender != thisPeer;
	}

	public boolean sentBySamePeerAs(PeerCard peer) {
		return peer != null && sender != null && peer.getPeerID() != null && peer.getPeerID().equals(sender.getPeerID())
				&& (peer.getRole() == sender.getRole() || peer.getRole() == null || sender.getRole() == null);
	}
	...
	public String toString() {
		...
		sb.append("\n  <uAAL:BusMessage#id>").append(id).append("</uAAL:BusMessage#id>");
		sb.append("\n  <uAAL:BusMessage#type>").append(type.name()).append("</uAAL:BusMessage#type>");
		sb.append("\n  <uAAL:BusMessage#content>\n").append(getContentAsString())
				.append("\n    </uAAL:BusMessage#content>");
		if (inReplyTo != null) {
			sb.append("\n  <uAAL:BusMessage#inReplyTo>").append(inReplyTo).append("</uAAL:BusMessage#inReplyTo>");
		}
