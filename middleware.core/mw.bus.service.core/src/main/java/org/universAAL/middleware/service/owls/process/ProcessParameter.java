...
public class ProcessParameter extends Variable {
	...
	public static final String PROP_OWLS_VALUE_FROM_PROCESS = OWLS_PROCESS_NAMESPACE + "fromProcess";
	...
	private static VariableHandler handler = new VariableHandler() {
		...
		public boolean checkDeserialization(Object o) {
			if (isVarRef(o)) {
				...
				return (var == null) ? false : ((Resource) o).changeProperty(PROP_OWLS_VALUE_OF_THE_VAR, var);
			}
			return true;
		}
	};
