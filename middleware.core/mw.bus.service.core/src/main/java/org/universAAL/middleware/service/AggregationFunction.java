...
public final class AggregationFunction extends FinalizedResource {
	...
	private static final String[] names = { "one_of", "min_of", "max_of", "min_distance_to_ref_loc",
			"max_distance_to_ref_loc" };

	public static final AggregationFunction oneOf = new AggregationFunction(ONE_OF);
	public static final AggregationFunction minOf = new AggregationFunction(MIN_OF);
	public static final AggregationFunction maxOf = new AggregationFunction(MAX_OF);
	public static final AggregationFunction minDistanceToRefLoc = new AggregationFunction(MIN_DISTANCE_TO_REF_LOC);
	public static final AggregationFunction maxDistanceToRefLoc = new AggregationFunction(MAX_DISTANCE_TO_REF_LOC);
