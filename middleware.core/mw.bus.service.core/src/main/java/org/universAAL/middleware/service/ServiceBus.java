...
public interface ServiceBus {
	 ...
	 *         registered.
	 */
	public ServiceProfile[] getMatchingServices(String callerID, Service template);
	 ...
	 *         has been registered.
	 */
	public ServiceProfile[] getMatchingServices(String callerID, String serviceClassURI);
	 ...
	 */
	public HashMap<String, List<ServiceProfile>> getMatchingServices(String serviceClassURI);
}
