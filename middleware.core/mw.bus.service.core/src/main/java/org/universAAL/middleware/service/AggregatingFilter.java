...
public class AggregatingFilter extends FinalizedResource {
	...
	public boolean isWellFormed() {
		return props.containsKey(PROP_uAAL_AGGREGATION_FUNCTION) && props.containsKey(PROP_uAAL_AGGREGATION_PARAMS);
	}
	...
	public boolean setProperty(String propURI, Object value) {
		...
		} else if (propURI.equals(PROP_uAAL_AGGREGATION_PARAMS) && value instanceof List && !((List) value).isEmpty()) {
			func = getTheFunction();
			params = (List) value;
		} else
			return false;
