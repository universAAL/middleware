...
public final class InitialServiceDialog extends UserInterfaceService {
	 ...
	 *      String)
	 */
	public static ServiceProfile createInitialDialogProfile(String serviceClassURI, String vendor, String description,
			String startServiceURI) {
		return createServiceProfile(new InitialServiceDialog(startServiceURI), serviceClassURI, vendor, description,
				startServiceURI);
	}
	 ...
	 *      ServiceCaller)
	 */
	public static String getInitialDialogDescription(String serviceClassURI, String vendor, ServiceCaller theCaller) {
	 ...
	 */
	public static ServiceRequest getInitialDialogRequest(String serviceClassURI, String vendor,
	 ...
	 */
	public static boolean startInitialDialog(String serviceClassURI, String vendor, Resource requestingUser,
			ServiceCaller theCaller) {
		ServiceResponse resp = theCaller
				.call(getUIServiceRequest(new InitialServiceDialog(), serviceClassURI, vendor, requestingUser));
