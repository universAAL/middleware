...
public class MyCommunicationModule implements CommunicationModule {
	...
	MyCommunicationModule(List<PeerCard> lstCards, Map<String, String> mapReadableNodes) {
	...
	public void addMessageListener(MessageListener listener, String channelName) {
		...
		if (listener instanceof ServiceBusImpl) {
			...
			System.out.println("ERROR: MyCommunicationModule.addMessageListener called with non-ServiceBusImpl");
		}
	}

	public MessageListener getListenerByNameAndType(String arg0, @SuppressWarnings("rawtypes") Class arg1) {
		return null;
	}
	...
	public void send(ChannelMessage message, PeerCard receiver) throws CommunicationModuleException {
		MessageListener listener = listeners.get(receiver.getPeerID());
		if (listener == null) {
			System.out.println(
					"ERROR: MyCommunicationModule.send: listener is null for receiver " + receiver.getPeerID());
			return;
		}
	...
	public void send(ChannelMessage message, MessageListener arg1, PeerCard receiver)
	...
	public void sendAll(ChannelMessage message, List<PeerCard> receivers) throws CommunicationModuleException {
		// not needed
	}

	public void sendAll(ChannelMessage message, MessageListener arg1) throws CommunicationModuleException {
	...
	public void sendAll(ChannelMessage message, List<PeerCard> receivers, MessageListener arg2)
			throws CommunicationModuleException {
