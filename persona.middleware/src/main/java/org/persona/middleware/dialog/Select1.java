...
public class Select1 extends Select {
	public static final String MY_URI = Form.PERSONA_DIALOG_NAMESPACE + "Select1";
	 ...
	 * 
	 * @param parent The group to contain this select1 object.
	 * @param label The label.
	 * @param ref mandatory property path within the form data to which this select1 object refers.
	 * @param valueRestriction Optional local restrictions on the value of this select1 object.
	 * @param initialValue Optional initial / default value that will be made available in the form data.
	 */
	public Select1(Group parent, Label label,
