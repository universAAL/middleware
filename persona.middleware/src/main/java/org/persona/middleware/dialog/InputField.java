...
public class InputField extends Input {
	public static final String MY_URI = Form.PERSONA_DIALOG_NAMESPACE + "InputField";
	
	/**
	 * To be set by applications if the field value, e.g. a password, should be kept secret during the
	 * presentation of the form.
	 */
	public static final String PROP_IS_SECRET = Form.PERSONA_DIALOG_NAMESPACE + "isSecret";
	
	/**
	 * To be set by applications (recommended) to declare a general restriction on the number of
	 * characters in the string representation of any acceptable value for the corresponding input field.
	 */
	public static final String PROP_MAX_LENGTH = Form.PERSONA_DIALOG_NAMESPACE + "maxLength";
	 ...
	 */
	public InputField(Group parent, Label label,
	...
	/**
	 * Overrides the default implementation in {@link FormControl#getMaxLength()} in order to
	 * consider a possibly available value for {@link #PROP_MAX_LENGTH} at first.
	 */
