...
import de.fhg.igd.ima.sodapop.Subscriber;
import de.fhg.igd.ima.sodapop.msg.Message;

/**
 * Provides the interface to be implemented by context subscribers
...
public abstract class ContextSubscriber implements Subscriber {
	...
	protected ContextSubscriber(BundleContext context, ContextEventPattern[] initialSubscriptions) {
