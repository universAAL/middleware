...
/**
 * This class holds a queue of commands to send to particular remote peer Its
 * run method runs continuously until the close() method is called, and
...
public class Dispatcher extends Thread {
     ...
     * 
     * @param peer
     *            - the peer to send the queued commands to
     */
	...
	while (running) {
		...
		case PeerCommand.PROCESS_MESSAGE:
			...
			System.out
				.println("Failed processBusMessage() invocation with peer: "
					+ msg.peerId);
		    }
		    break;
		case PeerCommand.JOIN_BUS:
			...
			System.out
				.println("Failed joinBus() invocation with peer: "
					+ msg.peerId);
		    }
		    break;
		case PeerCommand.LEAVE_BUS:
			...
			System.out
				.println("Failed leaveBus() invocation with peer: "
					+ msg.peerId);
		    }
		    break;
		case PeerCommand.NOTICE_PEER_BUSES:
			...
			System.out
				.println("Failed noticePeerBusses() invocation with peer: "
					+ msg.peerId);
		    }
		    break;
		case PeerCommand.REPLY_PEER_BUSES:
			...
			System.out
				.println("Failed replyPeerBusses() invocation with peer: "
					+ msg.peerId);
		    }
		    break;
		}
