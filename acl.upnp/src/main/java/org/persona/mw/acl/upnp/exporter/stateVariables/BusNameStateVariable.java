...
package org.persona.mw.acl.upnp.exporter.stateVariables;
import org.osgi.service.upnp.UPnPStateVariable;
/* 
* @author <a href="mailto:francesco.furfari@isti.cnr.it">Francesco Furfari</a>
*/

public class BusNameStateVariable implements UPnPStateVariable{
	
	final private String NAME = "BusName";
	
	
	public BusNameStateVariable(){
	}
