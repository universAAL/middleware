...
public class ProcessBusMessageAction implements UPnPAction {
	...
	public final static String[] IN_ARG_NAMES = new String[]{BUS_NAME,MESSAGE};
	private UPnPStateVariable busName,message;
	private SodaPopPeer localPeer;
	
	
	public ProcessBusMessageAction(SodaPopPeer localPeer,UPnPStateVariable busName, UPnPStateVariable message){
