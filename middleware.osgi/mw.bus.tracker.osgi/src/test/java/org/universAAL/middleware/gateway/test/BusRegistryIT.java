...
public class BusRegistryIT extends IntegrationTest {
	...
	public void testBusRegistry() throws Exception {
		...
		IBusMemberRegistry registry = (IBusMemberRegistry) Activator.mc.getContainer().fetchSharedObject(Activator.mc,
		...
		Assert.isTrue(Arrays.equals(singleContextSubscriber, listener.getCounts()),
		...
		Assert.isTrue(Arrays.equals(singleContextPublisher, listener.getCounts()),
	...
	class MockUIHandler extends UIHandler {
		...
		protected MockUIHandler(ModuleContext context, UIHandlerProfile initialSubscription) {
	...
	class MockContextSubscriber extends ContextSubscriber {
		...
		protected MockContextSubscriber(ModuleContext context, ContextEventPattern[] initialSubscriptions) {
	...
	class MockServiceCallee extends ServiceCallee {
		...
		protected MockServiceCallee(ModuleContext context, ServiceProfile[] realizedServices) {
	...
	class MockBusRegistryListener implements IBusMemberRegistryListener {
		...
		public int[] getCounts() {
			return new int[] { serviceCalleesCount, serviceCallersCount, contextPubilshersCount,
					contextSubscribersCount, uiCallersCount, uiHandlersCount };
		}

		public void print() {
			int[] values = new int[] { serviceCalleesCount, serviceCallersCount, contextPubilshersCount,
					contextSubscribersCount, uiCallersCount, uiHandlersCount };
