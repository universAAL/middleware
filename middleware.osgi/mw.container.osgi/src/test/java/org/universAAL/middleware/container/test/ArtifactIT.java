...
public class ArtifactIT extends IntegrationTest {
	...
	uAALBundleContainer.THE_CONTAINER.shareObject(mc, o, new Object[] { o
		.getClass().getName() });
	uAALBundleContainer.THE_CONTAINER.removeSharedObject(mc, o,
	...
	try {
	    re = uAALBundleContainer.THE_CONTAINER.fetchSharedObject(mc,
		    new Object[] { o.getClass().getName() });
	    if (re == null) {
		fail();
	    }
