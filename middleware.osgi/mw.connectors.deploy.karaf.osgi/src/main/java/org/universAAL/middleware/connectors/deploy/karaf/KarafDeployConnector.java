            ...
            try {
                ...
                while (!end) {
                    ...
                    if (entry != null) {
                        ...
                        String parent = applicationFilePart.getParent();
                        if ( parent == null ) {
                            out = new FileOutputStream(entry.getName());
                        } else {
                            out = new FileOutputStream(parent + File.separatorChar + entry.getName() );
                        }
                ...
                if ( parentPartDir == null ) {
                    parentPartDir = new File(".");
                }
