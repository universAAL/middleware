...
/**
 * Support for the uAAL model of process effects. 
 * The uAAL model of process effects allows three types of effects all affecting a reachable property
...
public abstract class ProcessEffect {
	public static final String PROP_PROCESS_AFFECTED_PROPERTY =
		Resource.uAAL_SERVICE_NAMESPACE + "affectedProperty";
	public static final String PROP_PROCESS_PROPERTY_VALUE =
		Resource.uAAL_SERVICE_NAMESPACE + "propertyValue";
	public static final String TYPE_PROCESS_ADD_EFFECT =
		Resource.uAAL_SERVICE_NAMESPACE + "AddEffect";
	public static final String TYPE_PROCESS_CHANGE_EFFECT =
		Resource.uAAL_SERVICE_NAMESPACE + "ChangeEffect";
