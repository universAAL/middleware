 ...
 * following way:
 * <ol><li>Three uAAL-specific properties are added in order to be able to define cardinality
 ...
 *         be specified using a uAAL-specific property, namely <code>defaultValue</code>.
 * </ol>
 * 
 * @author mtazari
 *
...
public abstract class ProcessParameter extends Variable {
	...
	public static final String PROP_PARAMETER_DEFAULT_VALUE =
		uAAL_SERVICE_NAMESPACE + "defaultValue";
	public static final String PROP_PARAMETER_CARDINALITY =
		uAAL_SERVICE_NAMESPACE + "parameterCardinality";
	public static final String PROP_PARAMETER_MAX_CARDINALITY =
		uAAL_SERVICE_NAMESPACE + "parameterMaxCardinality";
	public static final String PROP_PARAMETER_MIN_CARDINALITY =
		uAAL_SERVICE_NAMESPACE + "parameterMinCardinality";
	...
	public static final boolean checkDeserialization(Object o) {
		if (isVarRef(o)) {
			...
			var = ProcessInput.MY_URI.equals(((Resource) var).getType())?
					(ProcessParameter) ProcessInput.toInput((Resource) var)
					: (ProcessParameter) ProcessOutput.toOutput((Resource) var);
			return (var == null)? false
					: ((Resource) o).changeProperty(PROP_OWLS_VALUE_OF_THE_VAR, var);
		}
		return true;
	}
	...
	public String getParameterType() {
		return ((Resource) props.get(PROP_OWLS_PROCESS_PARAMETER_TYPE)).getURI();
	}
