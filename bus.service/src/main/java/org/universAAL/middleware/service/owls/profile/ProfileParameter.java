 ...
 * value of the parameter), both mandatory. uAAL modifies this class the following way:<ul>
...
public abstract class ProfileParameter extends Resource {
	...
	public static final String PROP_uAAL_PARAMETER_VALUE_DATA =
		uAAL_VOCABULARY_NAMESPACE + "valueData";
	...
	/**
	 * Returns {@link Resource#PROP_SERIALIZATION_REDUCED} for the predefined properties
	 * otherwise {@link Resource#PROP_SERIALIZATION_OPTIONAL}. As the only non-literal property
	 ...
	 * return {@link Resource#PROP_SERIALIZATION_REDUCED} or {@link Resource#PROP_SERIALIZATION_FULL}.
	 * 
	...
	public boolean isWellFormed() {
		return (props.get(PROP_OWLS_PROFILE_S_PARAMETER) != null
					||  props.get(PROP_uAAL_PARAMETER_VALUE_DATA) != null);
	}
