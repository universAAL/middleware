...
public class FloorSwitcherPlace extends Place {
	...
	static {
		MY_URI = PERSONA_VOCABULARY_NAMESPACE + "FloorSwitcherPlace";
		//REACHES_Z_COORDINATE represents the Z Coordinate of a reached floor
		//a FloorSwitcher must reach at least 2 floors
		PROP_REACHES_Z_COORDINATE = PERSONA_VOCABULARY_NAMESPACE + "reachesZCoordinate";
		...
		PROP_HAS_INCLINATION = PERSONA_SERVICE_NAMESPACE + "hasInclination";
