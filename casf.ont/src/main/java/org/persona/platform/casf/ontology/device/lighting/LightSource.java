...
public class LightSource extends Device {
	...
	public FHLocation getAmbientCoverage() {
		return (FHLocation) props.get(PROP_AMBIENT_COVERAGE);
	}
	...
	//hier stand nur Location
	public FHLocation getSourceLocation() {
		return (FHLocation) props.get(PROP_SOURCE_LOCATION);
	}
