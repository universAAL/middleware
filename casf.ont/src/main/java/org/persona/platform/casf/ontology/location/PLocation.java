...
import org.persona.platform.casf.ontology.weather.Temperature;
...
public class PLocation extends Location {
	...
	static {
		MY_URI = PERSONA_VOCABULARY_NAMESPACE + "PLocation";
		PROP_HAS_POSITION = PERSONA_VOCABULARY_NAMESPACE + "has_position";
		PROP_IS_IN_PLACE=PERSONA_VOCABULARY_NAMESPACE + "is_in_place";
		PROP_IS_NEAR_ADDRESS=PERSONA_VOCABULARY_NAMESPACE + "is_near_address";
		PROP_HAS_TEMPERATURE = PERSONA_VOCABULARY_NAMESPACE + "has_temperature";
		PROP_TARGET_TEMPERATURE = PERSONA_VOCABULARY_NAMESPACE + "target_temperature";
