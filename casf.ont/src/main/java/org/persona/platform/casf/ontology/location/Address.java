...
public abstract class Address extends ManagedIndividual {
	...
	static {
		MY_URI = PERSONA_VOCABULARY_NAMESPACE + "Address";
		PROP_COUNTRY_NAME= PERSONA_VOCABULARY_NAMESPACE + "countryName";
		PROP_EXTENDED_ADDRESS= PERSONA_VOCABULARY_NAMESPACE + "extendedAddress";
		PROP_LOCALITY= PERSONA_VOCABULARY_NAMESPACE + "locality";
		PROP_POSTAL_CODE=PERSONA_VOCABULARY_NAMESPACE + "postalCode";
		PROP_REGION = PERSONA_VOCABULARY_NAMESPACE + "region";
