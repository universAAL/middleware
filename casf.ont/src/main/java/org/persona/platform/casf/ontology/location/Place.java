...
*/
package org.persona.platform.casf.ontology.location;
...
public abstract class Place extends ManagedIndividual {
	...
	static {
		MY_URI = PERSONA_VOCABULARY_NAMESPACE + "Place";
		//a place can be connected to another place (i.e. there is a door that connects them)
		PROP_HAS_CONNECTION= PERSONA_VOCABULARY_NAMESPACE + "hasConnection";
		//a place can have a relative or an absolute position
		PROP_HAS_POSITION = PERSONA_VOCABULARY_NAMESPACE + "hasPosition";
		PROP_HAS_NAME = PERSONA_VOCABULARY_NAMESPACE  + "hasName";
		PROP_HAS_PLACETYPE = PERSONA_VOCABULARY_NAMESPACE + "hasPlaceType";
		PROP_IS_ADJACENT_TO = PERSONA_VOCABULARY_NAMESPACE + "isAdjacentTo";
		//usually a room place is contained in a building place
		PROP_IS_IN_PLACE = PERSONA_VOCABULARY_NAMESPACE+ "isInPlace";
		//usually a building place contains one or more places
		PROP_CONTAINS_PLACE=PERSONA_VOCABULARY_NAMESPACE+ "containsPlace";
		PROP_HAS_ADDRESS = PERSONA_VOCABULARY_NAMESPACE + "hasAddress";
