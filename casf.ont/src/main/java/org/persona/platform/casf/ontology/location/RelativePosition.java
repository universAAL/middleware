...
public class RelativePosition extends ManagedIndividual implements Position{
	...
	static {
		MY_URI = PERSONA_VOCABULARY_NAMESPACE + "RelativePosition";
		PROP_X= PERSONA_VOCABULARY_NAMESPACE + "X";
		PROP_Y = PERSONA_VOCABULARY_NAMESPACE + "Y";
		PROP_Z = PERSONA_VOCABULARY_NAMESPACE + "Z";
