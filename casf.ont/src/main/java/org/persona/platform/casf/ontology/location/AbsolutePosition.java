...
public class AbsolutePosition extends Point implements Position {
	...
	static {
		MY_URI = PERSONA_VOCABULARY_NAMESPACE + "absolutePosition";
		PROP_ALTITUDE_ACCURACY = PERSONA_VOCABULARY_NAMESPACE + "altitudeAccuracy";
		PROP_HAS_TRACK_MADE_GOOD = PERSONA_VOCABULARY_NAMESPACE + "has_track_made_good";
