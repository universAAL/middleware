...
public class PhysicalAddress extends Address {
	...
	static {
		MY_URI = PERSONA_VOCABULARY_NAMESPACE + "physicalAddress";
		// the building identifier is often a number (e.g. 280), but sometimes it can be
		// an alphanumeric string (e.g. 41E)
		PROP_BUILDING_IDENTIFIER = PERSONA_VOCABULARY_NAMESPACE + "buildingIdentifier";
		PROP_STREET_NAME = PERSONA_VOCABULARY_NAMESPACE + "streetName"; 
