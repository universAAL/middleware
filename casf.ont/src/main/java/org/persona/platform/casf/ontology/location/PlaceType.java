...
public class PlaceType extends ManagedIndividual {
	...
	static {
		MY_URI = PERSONA_VOCABULARY_NAMESPACE + "PlaceType";
    ...
    public static final PlaceType valueOf(String name) {
    	...
    	if (name.startsWith(PERSONA_VOCABULARY_NAMESPACE))
    		name = name.substring(PERSONA_VOCABULARY_NAMESPACE.length());
    ...
    public static ManagedIndividual getIndividualByURI(String instanceURI) {
		if (instanceURI==null || !(instanceURI.startsWith(PERSONA_SERVICE_NAMESPACE)))
			return null;
