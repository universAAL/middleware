...
public class Point extends ManagedIndividual {
	...
	static {
		MY_URI = PERSONA_VOCABULARY_NAMESPACE + "Point";
		PROP_ALTITUDE = PERSONA_VOCABULARY_NAMESPACE + "altitude";
		PROP_LATITUDE = PERSONA_VOCABULARY_NAMESPACE + "latitude";
		PROP_LONGITUDE = PERSONA_VOCABULARY_NAMESPACE + "longitude";
