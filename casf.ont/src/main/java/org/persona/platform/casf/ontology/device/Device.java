...
public abstract class Device extends PhysicalThing {
	public static final String PERSONA_DEVICE_NAMESPACE = PERSONA_NAMESPACE_PREFIX + "Device.owl#";
	public static final String MY_URI;
	public static final String PROP_BATTERY_LEVEL;
	static {
		MY_URI = PERSONA_DEVICE_NAMESPACE + "Device";
		PROP_BATTERY_LEVEL=Device.PERSONA_DEVICE_NAMESPACE+"batteryLevel";
	...
	public static String getRDFSComment() {
		return "The root class for all devices in the PERSONA ontology.";
	}
