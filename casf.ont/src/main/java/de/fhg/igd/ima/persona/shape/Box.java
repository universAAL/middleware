...
public class Box extends Shape3D {
	...
	static {
		MY_URI = PERSONA_SHAPE_NAMESPACE + "Box";
		PROP_WIDTH = PERSONA_SHAPE_NAMESPACE + "Width";
		PROP_HEIGHT = PERSONA_SHAPE_NAMESPACE + "Height";
		PROP_DEPTH = PERSONA_SHAPE_NAMESPACE + "Depth";
		register(Box.class);
	}
