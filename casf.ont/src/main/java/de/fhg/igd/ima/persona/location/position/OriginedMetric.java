...
public class OriginedMetric extends CoordinateSystem {
	...
	static {
		MY_URI = FHLocation.PERSONA_LOCATION_NAMESPACE + "OriginedMetric";
		PROP_ORIGIN = FHLocation.PERSONA_LOCATION_NAMESPACE + "origin";
		PROP_ROTATE_X = FHLocation.PERSONA_LOCATION_NAMESPACE + "rotateX";
		PROP_ROTATE_Y = FHLocation.PERSONA_LOCATION_NAMESPACE + "rotateY";
		PROP_ROTATE_Z = FHLocation.PERSONA_LOCATION_NAMESPACE + "rotateZ";
