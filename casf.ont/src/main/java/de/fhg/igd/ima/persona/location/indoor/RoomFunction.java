...
public class RoomFunction extends ManagedIndividual {
	...
	static {
		MY_URI = FHLocation.PERSONA_LOCATION_NAMESPACE + "RoomFunction";
	...
	public static ManagedIndividual getIndividualByURI(String instanceURI) {
		return (instanceURI != null
				&&  instanceURI.startsWith(FHLocation.PERSONA_LOCATION_NAMESPACE))?
						valueOf(instanceURI.substring(FHLocation.PERSONA_LOCATION_NAMESPACE.length()))
						: null;
	}
