...
public abstract class Shape extends ManagedIndividual {
	...
	public static final String PERSONA_SHAPE_NAMESPACE = "http://ontology.persona.ima.igd.fhg.de/Shape.owl#";
	...
	static {
		MY_URI = PERSONA_SHAPE_NAMESPACE + "Shape";
		PROP_POINT_REPRESENTATION = PERSONA_SHAPE_NAMESPACE
				+ "PointReperesentation";
		PROP_LOCAL_COORDINATE_SYSTEM = PERSONA_SHAPE_NAMESPACE
				+ "localCoordSys";
		PROP_BOUNDING_VOLUME = PERSONA_SHAPE_NAMESPACE + "boundingVolume";
	...
	public static Restriction getClassRestrictionsOnProperty(String propURI) {
		...
		if (PROP_BOUNDING_VOLUME.equals(propURI))
			return Restriction.getAllValuesRestrictionWithCardinality(propURI,
					Shape.MY_URI, 1, 1);
		return ComparableIndividual.getClassRestrictionsOnProperty(propURI);
	}
