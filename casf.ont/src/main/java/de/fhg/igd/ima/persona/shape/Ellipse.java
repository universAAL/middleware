...
public class Ellipse extends Shape2D {
	...
	static {
		MY_URI = PERSONA_SHAPE_NAMESPACE + "Ellipse";
		PROP_MINOR_AXIS_LENGTH = PERSONA_SHAPE_NAMESPACE + "MinorAxisLength";
		PROP_MAJOR_AXIS_LENGTH = PERSONA_SHAPE_NAMESPACE + "MajorAxisLength";
