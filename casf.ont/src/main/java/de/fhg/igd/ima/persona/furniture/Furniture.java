...
*/
package de.fhg.igd.ima.persona.furniture;

import org.persona.ontology.expr.Restriction;

import de.fhg.igd.ima.persona.FHPhysicalThing;
import de.fhg.igd.ima.persona.location.indoor.HomeArea;
import de.fhg.igd.ima.persona.location.indoor.RoomFunction;
import de.fhg.igd.ima.persona.shape.Shape;

public class Furniture extends FHPhysicalThing {
	public static final String MY_URI;
	public static final String PERSONA_FURNITURE_NAMESPACE = PERSONA_NAMESPACE_PREFIX + "Furniture.owl#";
	...
	public static Restriction getClassRestrictionsOnProperty(String propURI) {
		...
		return FHPhysicalThing.getClassRestrictionsOnProperty(propURI);
	}

	public static String[] getStandardPropertyURIs() {
		String[] inherited = FHPhysicalThing.getStandardPropertyURIs();
