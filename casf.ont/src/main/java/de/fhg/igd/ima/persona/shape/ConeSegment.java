...
import de.fhg.igd.ima.persona.furniture.FurnitureType;
...
public class ConeSegment extends LineSegment {
	...
	static {
		MY_URI = PERSONA_SHAPE_NAMESPACE + "ConeSegment";
		PROP_RADIUS_START = PERSONA_SHAPE_NAMESPACE + "RadiusStart";
		PROP_RADIUS_END = PERSONA_SHAPE_NAMESPACE + "RadiusEnd";
	...
	public ConeSegment(String uri,Point start,Point end,float radius_start,float radius_end) {
		super((uri == null  ||  uri.lastIndexOf('#') > 0)? uri
				: MiddlewareConstants.PERSONA_MIDDLEWARE_LOCAL_ID_PREFIX + uri,
				start, end);
