...
*/
package de.fhg.igd.ima.persona.location.position;
...
import de.fhg.igd.ima.persona.location.indoor.IndoorPlace;
...
public class Point extends FHLocation {
	...
	static {
		MY_URI = PERSONA_LOCATION_NAMESPACE + "Point";
		PROP_X = PERSONA_LOCATION_NAMESPACE + "xPosition";
		PROP_Y = PERSONA_LOCATION_NAMESPACE + "yPosition";
		PROP_Z = PERSONA_LOCATION_NAMESPACE + "zPosition";
		PROP_COORDINATE_SYSTEM = PERSONA_LOCATION_NAMESPACE + "coordianteSystem";
