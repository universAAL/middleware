...
public class Activator implements BundleActivator, ManagedService {
	...
	context.registerService(TypeMapper.class.getName(), TypeMapper
		.getTypeMapper(), null);
    }
	...
	middlewareProps.put(uAAL_CONF_ROOT_DIR, System.getProperty(
		uAAL_CONF_ROOT_DIR, System.getProperty("user.dir")));
