...
public class Constants {
    ...
    static {
	uAAL_MIDDLEWARE_LOCAL_ID_PREFIX = Activator
		.getMiddlewareProp(Activator.uAAL_AAL_SPACE_ID)
		+ "#";
    }
     ...
     * 
     * @see org.universAAL.middleware.Activator#uAAL_IS_DEBUG_MODE
     */
    public static boolean debugMode() {
	return "true".equals(Activator
		.getMiddlewareProp(Activator.uAAL_IS_DEBUG_MODE));
    }

    /**
     * Return true, if this peer is the coordinator.
     * 
     * @see org.universAAL.middleware.Activator#uAAL_IS_COORDINATING_PEER
     */
    public static boolean isCoordinatorInstance() {
	return "true".equals(Activator
		.getMiddlewareProp(Activator.uAAL_IS_COORDINATING_PEER));
    }

    /**
     * Return the root directory of the runtime configuration.
     * 
     * @see org.universAAL.middleware.Activator#uAAL_CONF_ROOT_DIR
     */
