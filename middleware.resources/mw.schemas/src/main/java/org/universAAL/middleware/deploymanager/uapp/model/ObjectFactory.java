 ...
 * generated in the org.universAAL.middleware.deploymaneger.uapp.model package. 
...
public class ObjectFactory {
    ...
    private final static QName _OntologyTypeLocationUrl_QNAME = new QName("http://universaal.org/aal-uapp/v1.0.0", "url");
    private final static QName _OntologyTypeLocationRuntimeId_QNAME = new QName("http://universaal.org/aal-uapp/v1.0.0", "runtimeId");
    private final static QName _OntologyTypeLocationPath_QNAME = new QName("http://universaal.org/aal-uapp/v1.0.0", "path");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.universAAL.middleware.deploymaneger.uapp.model
     * 
     */
    ...
    /**
     * Create an instance of {@link ToBeDefinedUSRVField }
     * 
     */
    public ToBeDefinedUSRVField createToBeDefinedUSRVField() {
        return new ToBeDefinedUSRVField();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://universaal.org/aal-uapp/v1.0.0", name = "url", scope = OntologyType.Location.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://universaal.org/aal-uapp/v1.0.0", name = "runtimeId", scope = OntologyType.Location.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://universaal.org/aal-uapp/v1.0.0", name = "path", scope = OntologyType.Location.class)
