...
public class ObjectFactory {
	...
	private final static QName _OntologyTypeLocationUrl_QNAME = new QName("http://www.universaal.org/aal-uapp/v1.0.2",
			"url");
	private final static QName _OntologyTypeLocationRuntimeId_QNAME = new QName(
			"http://www.universaal.org/aal-uapp/v1.0.2", "runtimeId");
	private final static QName _OntologyTypeLocationPath_QNAME = new QName("http://www.universaal.org/aal-uapp/v1.0.2",
			"path");
