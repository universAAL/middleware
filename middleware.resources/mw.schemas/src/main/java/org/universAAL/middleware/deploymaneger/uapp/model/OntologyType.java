    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        private final static long serialVersionUID = 12343L;
        @XmlElementRefs({
            @XmlElementRef(name = "runtimeId", namespace = "http://www.venstar.de", type = JAXBElement.class),
            @XmlElementRef(name = "path", namespace = "http://www.venstar.de", type = JAXBElement.class),
            @XmlElementRef(name = "url", namespace = "http://www.venstar.de", type = JAXBElement.class)
        })
