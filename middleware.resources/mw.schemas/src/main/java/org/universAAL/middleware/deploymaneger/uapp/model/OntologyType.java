    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        private final static long serialVersionUID = 12343L;
        @XmlElementRefs({
            @XmlElementRef(name = "path", namespace = "http://universaal.org/aal-uapp/v1.0.0", type = JAXBElement.class),
            @XmlElementRef(name = "url", namespace = "http://universaal.org/aal-uapp/v1.0.0", type = JAXBElement.class),
            @XmlElementRef(name = "runtimeId", namespace = "http://universaal.org/aal-uapp/v1.0.0", type = JAXBElement.class)
        })
