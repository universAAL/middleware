 ...
 * {@link org.universAAL.middleware.output.OutputSubscriber#handleOutputEvent(org.universAAL.middleware.output.OutputEvent)}
...
public class Form extends Resource {
	 ...
	 * {@link org.universAAL.middleware.input.InputEvent#getUserInput(String[])}
	...
	static Restriction getPPathRestriction(String[] pp, Resource pr) {
	 ...
	 * an {@link org.universAAL.middleware.output.OutputEvent}. See also the
	 ...
	 *         publish within an
	 *         {@link org.universAAL.middleware.output.OutputEvent}.
	 */
	...
	static {
		addResourceClass(MY_URI, Form.class);
	}
