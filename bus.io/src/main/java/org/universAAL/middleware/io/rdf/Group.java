...
public class Group extends FormControl {
    ...
    static {
	addResourceClass(MY_URI, Group.class);
    }
    ...
    public Group(Group parent, Label label, PropertyPath ref,
	    Restriction valueRestriction, Resource initialValue) {
	...
	String t = getTypeURI();
	if (t == null) {
	    LogUtils.logWarn(SharedResources.moduleContext, Group.class,
	...
	for (int i = 0; i < props.length; i++) {
	    Restriction r = ManagedIndividual.getClassRestrictionsOnProperty(t,
		    props[i]);
	    if (r == null) {
		LogUtils
			.logWarn(
		...
		if (tt == null)
		    ...
		    LogUtils.logWarn(SharedResources.moduleContext,
			    Group.class, "doModelBasedExpansion", new Object[] {
	...
	if (r instanceof Restriction
	    ...
	    Restriction target = ((Restriction) r)
