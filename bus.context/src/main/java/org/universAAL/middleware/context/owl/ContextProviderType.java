 ...
 * a gauge, or a reasoner. A controller is a context provider that has the control over some
...
public class ContextProviderType extends ManagedIndividual {
	...
	public static ManagedIndividual getIndividualByURI(String instanceURI) {
		return (instanceURI != null
				&&  instanceURI.startsWith(ContextEvent.uAAL_CONTEXT_NAMESPACE))?
						valueOf(instanceURI.substring(ContextEvent.uAAL_CONTEXT_NAMESPACE.length()))
						: null;
	}
